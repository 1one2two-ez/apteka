    ...
    <main>
        <div class="container">
            ...
            <div class="product-details">
                ...
                if (isset($_GET['id'])) {
                    $productId = $_GET['id'];
                    $sql = "SELECT * FROM `category-4` WHERE id = $productId";
            ...
            <div class="button-1">
                ...
                <!-- Форма для отправки комментариев (скрыта по умолчанию) -->
            ...
            <!-- PHP скрипт для обработки отправки комментариев -->
            <?php
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                // Проверка наличия комментария с таким именем и текстом
            ...
            <!-- JavaScript для управления видимостью формы -->
            <script>
